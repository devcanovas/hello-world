...
import backgroundImage from "assets/sobre_mim_capa.png";

const Sobremim = () => {
  const urlFotoSobreMim = "http://github.com/devcanovas.png";
  return (
    <PostModel backgroundImage={backgroundImage} title={"Sobre mim"}>
      <h3 className={styles.subtitulo}>Olá eu sou o Matheus!</h3>

      <img
        src={urlFotoSobreMim}
        alt="Foto do Matheus de sua conta do github"
